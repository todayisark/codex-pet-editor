...
export function buildPetJson(project: SpriteProject): string {
...
export function downloadPetJson(project: SpriteProject): void {
  downloadBlob(
    new Blob([buildPetJson(project)], { type: "application/json" }),
    "pet.json",
  );
}

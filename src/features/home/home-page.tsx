    ...
    step: [
      {
        '@type': 'HowToStep',
        name: 'Add frames',
        text: 'Add transparent images to the animation grid.',
      },
      {
        '@type': 'HowToStep',
        name: 'Preview and check',
        text: 'Preview each state and verify the sprite layout.',
      },
      {
        '@type': 'HowToStep',
        name: 'Export',
        text: 'Download the sprite sheet and pet.json configuration.',
      },
      {
        '@type': 'HowToStep',
        name: 'Install',
        text: 'Place the exported files in the Codex pets folder, then refresh Settings > Pets.',
      },
    ],
  },
];
    ...
    <main>
      ...
      <header className="hero">
        <div className="hero-content">
          ...
          <p className="intro">
            Codex Pets bring a character to your desktop with animated states for idling, working,
            reviewing, and more. Build a compatible v1 or v2 sprite sheet here, entirely in your
            browser.
          </p>
          ...
          <div className="install-note">
            ...
            <p>
              Extract the exported folder here so it contains <code>pet.json</code> and{' '}
              <code>spritesheet.webp</code>. Then open <strong>Settings → Pets</strong>, refresh the
              list, and select your pet.
            </p>
          </div>
